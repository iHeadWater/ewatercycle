...
from hydromodel.models.xaj import generation, sources, sources5mm
from test.test_data import test_save_data
...
class xajBmi():
    ...
    def initialize(self, config_file):
        ...
        # configuration.process_inputs(config['forcing_file'], config['json_file'], config['npy_file'], config)
